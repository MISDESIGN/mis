...
CREATE TABLE `details` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `receivertel_UNIQUE` (`receivertel`),
  KEY `1_idx` (`companyid`),
...
INSERT INTO `details` VALUES (1,1,1,'a','123','矿大','b','456','北京',NULL,NULL,'2016-11-11',NULL,NULL),(2,3,2,'b','775743597','矿大','b','678','上海',NULL,NULL,'2016-11-11',NULL,1);
...
CREATE TABLE `user` (
  ...
  `ssh` varchar(45) DEFAULT NULL,
  `kdID` int(11) NOT NULL,
  PRIMARY KEY (`kdID`),
  KEY `2_idx` (`phone`),
  CONSTRAINT `1` FOREIGN KEY (`kdID`) REFERENCES `details` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `2` FOREIGN KEY (`phone`) REFERENCES `details` (`receivertel`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('123','123','杏三','B4055',1);
...
-- Dump completed on 2016-12-05 17:14:01
