...
INSERT INTO `details` VALUES (1,1,'a','123','矿大','b','456','北京',NULL,NULL,'2016-11-11',NULL,NULL),(2,3,'b','775743597','矿大','b','678','上海',NULL,NULL,'2016-11-11',NULL,1);
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`phone`),
  CONSTRAINT `1` FOREIGN KEY (`phone`) REFERENCES `details` (`receivertel`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-28 16:28:37
